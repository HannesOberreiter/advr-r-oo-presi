...
- **Performance**
- Loops: Iternations depend on previous ones
- Millions of Recusive Hell'ish calls (Mandelbrot?)
...
- source C++ fliles with `sourceCpp()`
- file extension `.cpp`
...
> This document provides a short overview of how to use Rcpp (Eddelbuettel et al., 2021a; Eddelbuettel and François, 2011; Eddelbuettel,
2013) when writing an R package. It shows how usage of the function
Rcpp.package.skeleton which creates a complete and self-sufficient
example package using Rcpp. All components of the directory tree created by Rcpp.package.skeleton are discussed in detail. This document
thereby complements the Writing R Extensions manual (R Core Team,
2018) which is the authoritative source on how to extend R in general.
